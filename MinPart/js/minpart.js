        ...
        if (foo == true) {
            switch (currentStep) {
                ...
                case 5:
                    ...
                    $.post('WebServices/custom/WVC/ServingTagNotification.asmx/UpdatePerson',
                        {
                            user_name: $("input[name$=user_name]").val(),
                            message: "Ministry Partner Application Completed"
                        }, function (data) {
                         var response = $.xml2json(data);
                         });
                    break;
...
function validateStep(step) {
    var steps = ["#first", "#second", "#third", "#fourth", "#fifth", "#final"];
    var foo = true;
