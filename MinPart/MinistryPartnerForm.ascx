<%@ Control Language="C#" Inherits="ArenaWeb.UserControls.Custom.WVC.MPF.MinistryPartnerForm" CodeFile="MinistryPartnerForm.ascx.cs" CodeBehind="MinistryPartnerForm.ascx.cs" %>
...
<div id="formWrapper" style="display: none;">
  ...
  <div>
All fields with a red arrow (<img src="/UserControls/Custom/WVC/MinPart/images/backgrounds/required.gif" />) are required.
</div>
  <div class="clear">&nbsp;</div>
