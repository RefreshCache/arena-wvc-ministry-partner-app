  ...
  <div class="clear">&nbsp;</div>
    ...
    <fieldset class="step" id="sixth">
      ...
      <div>
        ...
        <select name="preferredCampus" id="preferredCampus" runat="server" attid="193" class="required">
      ...
      <div>
        <label for="ageGroup" title="Preferred Age Group">Preferred Age Group:</label>
        <select name="ageGroup" id="ageGroup" runat="server" attid="258" class="required">
            <option value="">Select...</option>
      ...
      <div>
        <label for="timeOfService" title="Preferred Opportunity">Preferred Opportunity:</label>
        <select name="timeOfService" id="timeOfService" runat="server" attid="259" class="required">
            <option value="">Select...</option>
            <option value="Sunday Night Small Group Leader">Sunday Night Small Group Leader</option>
            <option value="Mid-week Small Group Leader">Mid-week Small Group Leader</option>
            <option value="Sunday Morning Bible Study Leader">Sunday Morning Bible Study Leader</option>
        </select>
      </div>
      <div>
        <label for="driversLicense" title="Drivers License">Drivers License</label>
        <input type="text" name="driversLicense" id="driversLicense" runat="server" attid="147" class="required" />
      </div>
      <div>
      ...
      <div>
        ...
        <textarea cols="50" rows="10" name="completeAddressHistory" id="completeAddressHistory" runat="server" attid="148" class="required"></textarea>
      </div>
      <div>
      ...
      <h4>Student's Ministries Volunteer Statement and Agreed Code of Conduct:</h4>
      <div>
      ...
      <div>
        <label class="vCentThree" for="teamMember" title="Be a good Team Member">I will not have inappropriate physical contact with anyone on the team. I understand that I am making a commitment to the Student's Ministry Department at Woodmen Valley Chapel and agree to be a responsible team member by doing the following:
            <br /><br />
                ...
                -Show respect to the leaders and students at all times<br /><br />
                ...
                -Attend other forums of training offered throughout the year to improve my skills and learn to better serve our students and families<br /><br />
